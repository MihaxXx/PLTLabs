...
Proof.
  ...
  - intros. inversion H. destruct h. destruct (split t).
    simpl in H1. inversion H1. simpl. apply tail_eq. apply IH.
    reflexivity.
Qed.
(** [] *)
...
Lemma eqb_true1: forall n m, n = m -> (n =? m) = true.
Proof. Admitted.
...
Proof.
  ...
  +  simpl. intros. destruct (test x) eqn:t.
    - inversion H. rewrite <- H1. rewrite t. reflexivity.
